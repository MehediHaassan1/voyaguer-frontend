    ...
    return (
        <div className="max-w-screen-xl mx-auto mt-16">
            <div className="text-center text-white" data-aos="fade-up">
                <h1 className="text-3xl lg:text-5xl ont-bold ">Our Guides</h1>
                <p className="font-mono md:text-xl mt-4">
                    Guiding your adventures, crafting unforgettable journeys.
                </p>
            </div>
            <div className="mt-10 grid grid-cols-1 md:grid-cols-3 md:gap-2 justify-items-center">
